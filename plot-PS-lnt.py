...
for path in os.listdir(dir_path):
    ...
    if os.path.isdir(os.path.join(dir_path, path)):
        ...
        #Plotting Ns vs PS
        plt.plot(np.log(graphing[0]), graphing[2] , c = colors[colorcount%10] , marker = ".", linestyle = "None", label = lam, markersize = 3)
        colorcount+=1
plt.legend(fontsize = 12, markerscale = 2)
plt.grid(alpha = 0.5, linestyle = "--")
plt.xlabel("log(t)", size = 12)
plt.ylabel("Ps", size = 12)
plt.xscale("log")
plt.yscale("log")
fig.savefig(r"C:\Users\Juan Felipe Barrera\Documents\College Northwestern\Kovacs Lab\DataWQ24\__Condensed\PSvslogt04-14.jpg", transparent = True, bbox_inches = 'tight', pad_inches = 0)
fig.savefig(r"C:\Users\Juan Felipe Barrera\Documents\College Northwestern\Kovacs Lab\DataWQ24\__Condensed\PSvslogt04-14.pdf", transparent = True, bbox_inches = 'tight', pad_inches = 0)